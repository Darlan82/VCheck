...
namespace VCheck.Modules.Fleet.MigrationService;
    ...
    : BackgroundService
{
    ...
    private static async Task RunMigrationAsync(FleetDbContext dbContext, CancellationToken cancellationToken)
    {
